    ...
    >
      ...
      <div className='grid grid-cols-1 md:grid-cols-3 gap-6'>
        {members.map((m, i) => (
          <div
            key={i}
            className='card-hover border border-white/5 p-8 relative overflow-hidden group'
            style={{
          ...
          >
            ...
            <div
              ...
              style={{
                background: `radial-gradient(ellipse at 30% 30%, ${m.color}06 0%, transparent 60%)`,
              }}
            />
